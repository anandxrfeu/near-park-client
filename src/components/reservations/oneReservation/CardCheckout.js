  ...
  <div style={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center"}}>
      <div style={{marginTop: "40px"}}>
        <div>
          ...
          <h1 style={{color: "green", marginLeft: "10px",fontWeight: "600" }}>{reservation.status === "PAID" ? "COMPLETE" : "PENDING"}</h1>
        </div>
      </div>
      ...
      <div style={{marginTop: "50px"}}>
        ...
        <div style={{display: "flex", justifyContent: "center", alignItems: "center", marginTop: "26px"}}>
          <button disabled={reservation.status !== 'PAID'}
          style={{color: "white", backgroundColor: "green",
          border: "2px solid green", width: "120px", height: "120px",
          borderRadius: "50%", fontWeight: "700", fontSize: "16px"}} onClick={confirmPaymentByCard}>CONFIRM</button>
        </div>
