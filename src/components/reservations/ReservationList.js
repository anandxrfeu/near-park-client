    ...
    <>
      <div className="TableMainContainer">
        <table className="tableListMain table-hover">
            <thead>
              <tr style={{border: "1px solid black", display: "flex", flexDirection: "row", justifyContent: 'space-between', height:"42px", paddingTop: "6px", paddingRight:"1.2%" , fontSize:"1.16em"}}>
